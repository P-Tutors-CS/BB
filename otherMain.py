...
def show_buttonybois():
    ...
    DISPLAYSURF.blit(
        clear_label,
        (CLEAR_ALL_RECT.x + x_offset, CLEAR_ALL_RECT.y + y_offset))
    ...
    DISPLAYSURF.blit(back_label,
                     (BACK_RECT.x + x_offset, BACK_RECT.y + y_offset))
    ...
    DISPLAYSURF.blit(divide_label,
                     (DIVIDE_RECT.x + x_offset, DIVIDE_RECT.y + y_offset))
    ...
    DISPLAYSURF.blit(multiply_label,
                     (MULTIPLY_RECT.x + x_offset, MULTIPLY_RECT.y + y_offset))
    ...
    DISPLAYSURF.blit(eight_label,
                     (EIGH_RECT.x + x_offset, EIGH_RECT.y + y_offset))
    ...
    DISPLAYSURF.blit(nine_label,
                     (NINE_RECT.x + x_offset, NINE_RECT.y + y_offset))
    ...
    DISPLAYSURF.blit(minus_label,
                     (MINUS_RECT.x + x_offset, MINUS_RECT.y + y_offset))
    ...
    DISPLAYSURF.blit(four_label,
                     (FOUR_RECT.x + x_offset, FOUR_RECT.y + y_offset))
    ...
    DISPLAYSURF.blit(zero_label,
                     (ZERO_RECT.x + x_offset, ZERO_RECT.y + y_offset))
    ...
    DISPLAYSURF.blit(dcml_label,
                     (DCML_RECT.x + x_offset, DCML_RECT.y + y_offset))
...
while True:
    ...
    temp = font.render("8", True, (255, 255, 255))
